    ...
    <div className="max-w-[1170px] mx-auto w-full px-4 md:px-8 lg:px-16">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between py-4">
        <div className="flex items-center gap-x-4 font-bold mb-4 md:mb-0">
          <h2 className="text-2xl md:text-4xl font-bold flex items-center justify-start md:pr-10">
            Best Selling Products
          </h2>
        </div>
        <button className="bg-[#db4444] text-white w-full md:w-[159px] h-[56px] rounded-md">
          View All
        </button>
      </div>
      ...
      <div className="bg-black w-full min-h-[500px] mx-auto flex flex-col md:flex-row justify-between p-4 md:p-8">
        <div className="w-full md:w-1/2 p-4 md:p-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pb-5 md:pb-10">
            {['23 Hours', '05 Days', '59 Minutes', '35 Seconds'].map((time, index) => {
              ...
              return (
                <div key={index} className="rounded-full bg-white p-4 text-center">
                  <p className="text-sm md:text-md font-bold">{value}</p>
        ...
        <div className="relative w-full md:w-1/2 h-[300px] md:h-[500px] mt-8 md:mt-0">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full flex items-center justify-center">
            <Image src="/product/product1.png" alt="boom box" width={500} height={500} />
          </div>
        </div>
      </div>
    </div>
